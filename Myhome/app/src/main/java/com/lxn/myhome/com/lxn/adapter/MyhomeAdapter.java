...
public class MyhomeAdapter extends RecyclerView.Adapter<MyhomeAdapter.ViewHolder> {
    ...
    public MyhomeAdapter(ArrayList<Home> listHome, Context mContext) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View itemview= inflater.inflate(R.layout.item_recycleview_home,parent,false);
    ...
    public void setNewData(ArrayList<Home> homes){
        listHome = homes;
